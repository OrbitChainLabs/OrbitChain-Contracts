...
impl ErrorMapper {
    ...
    pub fn load_builtin() -> Self {
        ...
        // ── Asset / transfer ──────────────────────────────────────────────
        codes.insert(30, ErrorEntry {
            code: 30,
            name: "InvalidRecipient".into(),
            message: "Recipient address is the contract itself — would lock funds permanently.".into(),
            severity: None,
        });
        codes.insert(31, ErrorEntry {
            code: 31,
            name: "MissingIssuerAddress".into(),
            message: "The asset has no issuer address; transfers require a token contract address.".into(),
            severity: None,
        });
        codes.insert(32, ErrorEntry {
            code: 32,
            name: "ZeroReleaseAmount".into(),
            message: "Computed release amount is zero after proportional rounding.".into(),
            severity: None,
        });
        codes.insert(33, ErrorEntry {
            code: 33,
            name: "NothingToRelease".into(),
            message: "released_amount already equals target_amount; nothing left to release.".into(),
            severity: None,
        });
        codes.insert(34, ErrorEntry {
            code: 34,
        ...
        // ── Milestone ─────────────────────────────────────────────────────
        codes.insert(40, ErrorEntry {
            code: 40,
            name: "MilestoneAlreadyReleased".into(),
            message: "Milestone is already in the Released state.".into(),
            severity: None,
        });
        codes.insert(41, ErrorEntry {
            code: 41,
            name: "UnreleasedMilestonesExist".into(),
            message: "All milestones must be Released before the campaign can be concluded.".into(),
            severity: None,
        });
